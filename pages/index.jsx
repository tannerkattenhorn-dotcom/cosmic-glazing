...
try {
const PROXY=“https://api.allorigins.win/raw?url=”+encodeURIComponent(“https://api.freeastroapi.com/api/v1/natal/calculate”);
  ...
  <div style={{position:"relative",zIndex:1,maxWidth:420,margin:"0 auto",padding:"0 16px 48px"}}>
    ...
    {screen === "intro" && (
      <div style={{animation:"fadeIn 0.5s ease"}}>
        ...
        <button onClick={()=>setScreen("apikey")} style={{width:"100%",padding:"17px",borderRadius:14,border:"1px solid #8B5CF688",background:"linear-gradient(135deg,#8B5CF622,#6366f115)",color:"white",fontSize:16,fontWeight:700,cursor:"pointer",letterSpacing:1,fontFamily:"serif",boxShadow:"0 0 28px #8B5CF622"}}>
          ✦ read my chart ✦
        </button>
